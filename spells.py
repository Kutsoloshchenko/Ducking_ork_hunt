...
class Spell(Animated_sprite):
    """Базовій класс заклинания от которого наследуются все"""
    def _move_x(self):
...
# """Что бы сделать копию заклинания для врага, нужно наслоджовать два класа,
# первый это бащовый класс заклинания, а второй - класс врожесого заклинания"""
